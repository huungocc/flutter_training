...
class _AddTodoBodyState extends State<_AddTodoBody> {
  ...
  void initState() {
    ...
    if (widget.arg != null) {
      ...
      _keyTime.text = DateFormat('h:mm a').format(DateFormat('HH:mm:ss').parse(widget.arg!.time!));
                          ...
                          child: BaseButton(
                            ...
                            onTap: () {
                              if (_keyTaskTitle.text.isNotEmpty && _keyDate.text.isNotEmpty && _keyTime.text.isNotEmpty && _keyNotes.text.isNotEmpty) {
                                ...
                                ExceptionHandler.showErrorSnackBar(AppLocalizations.of(context)!.please_fill_in_all_fields);
                              }
                            },
                          ),
                        )
